<template>
    <div class="physicalUsage">
        ...
        <physicalUsage1Dialog ref="physicalUsage1DialogRef" />
    </div>
</template>
...
import physicalUsage1Dialog from './physicalUsage1Dialog.vue';
...
const physicalUsage1DialogRef = ref(null);
const clickCallBack = async (p) => {
    physicalUsage1DialogRef.value.showModel = true;
};
// legenData处理
const legendData = () => {
    ...
    state.option = {
        ...
        series: [
            ...
            },
            {
                ...
                // data: [
                //     { time: '00:00:00', value: 34 },
                //     { time: '00:00:01', value: 54 },
                //     { time: '00:00:02', value: 11 },
                //     { time: '00:00:03', value: 23 }
                // ]
            ...
            },
            {
                ...
                // data: [
                //     { time: '00:00:00', value: 44 },
                //     { time: '00:00:01', value: 23 },
                //     { time: '00:00:02', value: 11 },
                //     { time: '00:00:03', value: 99 }
                // ]
