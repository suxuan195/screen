<template>
  <div class="centerBottom">
    ...
    <div class="chart">
      <my-chart :width="480" :height="130" :option="state.option" :clickA="true" @clickACallBack="clickCallBack"
        :params="_params"></my-chart>
    </div>
    <teleport to="#screen">
      <mixedOwnershipSituationPopUp :showModel="showModel" :modelId="modelId"></mixedOwnershipSituationPopUp>
    </teleport>
  </div>
</template>
...
import mixedOwnershipSituationPopUp from "./mixedOwnershipSituationPopUp.vue"
...
.centerBottom {
  ...
  .chart {
    background: url("@images/propertyManagement/item-bg-min.png") 0% 0% / 100% 100% no-repeat;
  }
}
</style>
