<template>
    <div class="decisionMakingDialog">
        <popup :width="1388" :height="596" title="事项列表" :showModel="props.showModel">
            <search class="marginBox" :formList="state.formList" :is-close="true" />
            <ulList :ul-list="state.ulList" class="ulListBox" />
