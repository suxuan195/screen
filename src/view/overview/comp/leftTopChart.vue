<template>
  <div class="leftTopChart">
    ...
    <div class="chart">
      ...
      <div class="bar">
        <my-chart :width="400" :height="96" :option="state.option" :click="true" :params="_params"
    ...
    <!-- 组织机构行业分布情况统计表 -->
    <teleport to="#screen">
      <organization-total-dialog ref="organizationTotalRef" />
    </teleport>
  </div>
</template>
...
import organizationTotalDialog from '../dialog/organizationTotalDialog.vue';
