<template>
    <Dialog :width="1600" :height="660" :showModel="showModel" title="企业信息" @close="close">
        <div class="table-wrap">
            <div class="form">
                <el-form :model="form" inline>
                    <el-form-item label="信用代码：">
                        <el-input v-model="form.topicN" placeholder="请输入" />
                    </el-form-item>
                    <el-form-item label="单位名称：">
                        <el-input v-model="form.meetingM" placeholder="请输入" />
                    </el-form-item>
            ...
            <custom-table class="mb20" :tableData="state.tableData" maxHeight="450px" :tableHeader="state.tableHeader"
