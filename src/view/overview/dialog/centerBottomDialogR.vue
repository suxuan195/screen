<template>
  <Dialog :width="1332" :height="560" :showModel="showModel" title="企业负债总额" @close="close">
    <div class="table-wrap">
      ...
      <div class="pagination">
        <el-pagination v-model:current-page="state.page" v-model:page-size="state.size" :page-sizes="[10, 20, 30, 40, 50]"
          background layout="total, sizes, prev, pager, next" :total="state.total" @size-change="handleSizeChange"
