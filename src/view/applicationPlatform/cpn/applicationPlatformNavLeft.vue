<template>
    <div class="applicationSystemNav">
        <p></p>
        <div>
            <span @click="handleClick"   >{{props.total}}</span>
            <i>个</i>
        </div>
    </div>
    <applicationPlatformList title="平台应用系统总量"  :showModel="showModel"  :tableData="state.tableData" :options="state.options" @close-dialog="closeDialog"></applicationPlatformList>
</template>
    
<script setup>
import applicationPlatformList from "./applicationPlatformList.vue"
// import physicalUsage1Dialog from '../../../components/applicationModuleManagment/physicalUsage1Dialog.vue'
...
.applicationSystemNav {
    ...
    // background-color: rgba(40, 44, 79,0.7);
    background-image: url("@images/IntelligentEnergyManagement/top1.png");
    ...
    //     // background-image: url('${props.imageUrl}');
        background-image: url('@images/applicationModuleManagment/应用系统总数量icon.png');
        background-size: 100% 100%;
        margin-right: 32px;
        margin-left:30px;
    }
