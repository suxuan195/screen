<template>
  <div class="centerMap">
    <!-- <div class="rightTable">
      ...
      <ScrollTable :tableData="state.tableData" :options="state.tableHeader"
        :colorList="state.tableHeader.map(item => item.prop).slice(1)" :height="80" style="padding: 0;margin-top: 14px;">
      </ScrollTable>
    </div> -->
...
const state = reactive({
    ...
    series: [
      {
        ...
        //   data: [
        //     { name: '酒泉集团', coord: [96.10946594329162, 40.72474512161307] } // 标记酒泉市的位置坐标
        //   ],
        //   label: {
        //     show: true,
        //     color: "#fff",
  ...
  tableHeader: [
    { prop: "sequence", label: "类别", width: "60" },
    { prop: "companytName", label: "党委会成员人数", width: "125" },
    { prop: "legalReviewError", label: "董事会成员人数", width: "125" },
    { prop: "conferenceError", label: "监事会成员人数", width: "125" },
  ],
  tableData: [
    {
      sequence: "合计",
