<template>
    ...
    <div class="main">
      <!-- <div class="slide">
        <el-scrollbar height="400px">
          <div class="list">
            <div v-for="(item, index) in props.slide" :key="index" @click="clickItem(index)"
              :class="`${state.tag == index ? 'active item' : 'item'}`">
              {{ item }}
            </div>
          </div>
        </el-scrollbar>
  ...
  borderImage: 'linear-gradient(180deg,  rgba(0, 155, 255, 0.1) 40%, rgba(0, 155, 255, 0.8) 100%) 2 2 2 2' /* 先设置透明的左边框 */
          ...
          <!-- <el-table-column prop="projectDominName" align="center" show-overflow-tooltip label="项目所属行业领域名称" width="200" /> -->
          <el-table-column prop="projectCountry" align="center" show-overflow-tooltip label="项目所在国家地区及城市" width="200" />
          <el-table-column prop="totalInvestment" align="center" show-overflow-tooltip label="投资总额(万元)" width="150" />
          <el-table-column prop="approvedAmount" align="center" show-overflow-tooltip label="国资委批复金额(万)" width="200" />
          <el-table-column prop="permanentPerson" align="center" show-overflow-tooltip label="常驻负责人" width="150" />
          <el-table-column prop="projectInvestor" align="center" show-overflow-tooltip label="项目投资方" width="150" />
          <el-table-column prop="projectPartner" align="center" show-overflow-tooltip label="项目合作方" width="150" />
        </el-table>
      </div>
    </div>
  </Popup>
