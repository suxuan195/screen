<template>
  ...
  <InComePopUp :showModel="showModel" />

  <TableWrapper :tableColumns="state.tableColumns" :tableData="state.tableData"   :showModel="showModels" />
</template>
...
import InComePopUp from "@components/popup/payrollManagement/InComePopUp.vue";
import TableWrapper from "@components/popup/payrollManagement/TableWrapper.vue";
import emitBus from "@utils/bus";
const title = ref("负责人薪资分布");
