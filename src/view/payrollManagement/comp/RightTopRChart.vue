<template>
  <Chart :title="title" :option="state.option" :more="true" :tag="`leftBottomChart`" :boxHeight="240" :boxWidth="432"
    :canvasWidth="392" :canvasHeight="180" :borderImg="borderImg" :highlight="true" @moreClick="moreClick"  :clickA="true" @clickACallBack="clickCallBack"
                :params="_params" ></Chart>
  <InComeCompositionPopUp :showModel="showModel" />

  <rightTable :tableColumns="state.tableColumns" :tableData="state.tableData"   :showModel="showModels" />
</template>

<script setup>
import { reactive, ref, onMounted, onBeforeMount, onUnmounted } from "vue";
import Chart from "@/components/Chart/Chart.vue";
import borderImg from "@images/payrollManagement/border-min.png";
...
import InComeCompositionPopUp from "@components/popup/payrollManagement/InComeCompositionPopUp.vue";
import rightTable from "@components/popup/payrollManagement/rightTable.vue";
import emitBus from "@utils/bus";
const title = ref("负责人收入组成");
