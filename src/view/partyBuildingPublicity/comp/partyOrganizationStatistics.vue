<template>
  <popup :width="768" :height="438" :showModel="props.showModel" title="党组织统计" class="popup1">
    <div class="tableX">
      <el-table :data="state.tableData" style="width: 100%" max-height="356px" :cell-style="cellStyle"
