<template>
    <div class="screen">
        <Header title="安全生产"></Header>
        <div class="main">
            <div class="leftBox">
                <navTitle title='安全生产事件统计' />
                <leftTopChart />
                <navTitle title='事故等级占比' class="mt50" />
                <leftBottomChart />
            </div>
            <div class="centerBox">
              <navTitle title='省属企业展示' />
              <centerTopChart/>
              <centerBottomChart class="mt24" />
            </div>
            <div class="rightBox">
                <navTitle title='各企业安全生产事件统计' />
                <rightTopChart />
                <rightBottomChart class="mt24" />
            </div>
        </div>
...
import centerTopChart from "./cpn/centerTopChart.vue";
...
.screen {
    background: url("@images/safeProduction/bg.jpg") 0% 0% / 100% 100% no-repeat;
    height: 100%;
    width: 100%;
